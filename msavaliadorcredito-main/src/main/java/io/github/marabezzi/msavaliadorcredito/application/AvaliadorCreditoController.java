...
import io.github.marabezzi.msavaliadorcredito.domain.model.DadosAvaliacao;
...
public class AvaliadorCreditoController {
	...
	public ResponseEntity<?> realizarAvaliacao(@RequestBody DadosAvaliacao dados) {
		try {
			RetornoAvaliacaoCliente retornoAvalicaoCliente = avaliadorCreditoService.realizarAvaliacao(dados.getCpf(),
					dados.getRenda());
